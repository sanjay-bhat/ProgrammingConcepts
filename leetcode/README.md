...
| :--- | :--- | :--- | :--- | :--- |
| 1074 | [📓 Number of Submatrices That Sum to Target](1074.ipynb) | 2D Prefix Sum + Hash Map | Time: O(n^3), Space: O(n^2)| Hard|
| 1033 | [📓 Matrix Block Sum](1033.ipynb) | 2D Prefix Sum | Time: O(m * n), Space: O(m * n)| Medium|
...
|4 | [📓 Median of Two Sorted Arrays](0004.ipynb) | Array, Binary Search | Time: O(log(min(m, n))), Space: O(1) | Hard|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
| 293 | [📓 Flip Game](0293.ipynb) | Single Scan | Time: O(n²), Space: O(n) per result | Easy |
| 784 | [📓 Letter Case Permutation](0784.ipynb) | Backtracking (DFS) | Time: $O(n \cdot 2^n)$, Space: $O(n)$ | Medium |
| 22 | [📓 Generate Parentheses](0022.ipynb) | Backtracking (DFS) | Time: $O\left(\frac{4^n}{\sqrt{n}}\right)$, Space: $O(n)$ | Medium |
| 39 | [📓 Combination Sum](0039.ipynb) | Backtracking (DFS) | Time: $O(N^{T/M})$, Space: $O(T/M)$ | Medium |
| 40 | [📓 Combination Sum II](0040.ipynb) | Backtracking (DFS) | Time: $O(2^N)$, Space: $O(N)$ | Medium |
|784 | [Letter Case Permutation](https://leetcode.com/problems/letter-case-permutation/) | Backtracking | Time: O(2^n), Space: O(1)| Easy|
| 17 | [📓 Letter Combinations of a Phone Number](0017.ipynb) | Backtracking | Time: O(4^n), Space: O(n)| Medium|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
| 429 | [📓 N-ary Tree Level Order Traversal](0429.ipynb) | BFS (Queue) | Time: $O(n)$, Space: $O(n)$ | Easy |
| 286 | [📓 Walls and Gates](0286.ipynb) | BFS (Queue) | Time: $O(m \cdot n)$, Space: $O(m \cdot n)$ | Medium |
| 433 | [📓 Minimum Genetic Mutation](0433.ipynb) | BFS (Queue) | Time: $O(N^2 \cdot L)$, Space: $O(N)$ | Medium |
| 1091 | [📓 Shortest Path in Binary Matrix](1091.ipynb) | BFS (Queue) | Time: $O(n^2)$, Space: $O(n^2)$ | Medium |
| 752 | [📓 Open the Lock](0752.ipynb) | BFS (Queue) | Time: $O(10^4 + D)$, Space: $O(10^4 + D)$ | Medium |
...
| 1| 293 | [📓 Flip Game](0293.ipynb) | Single Scan | Time: O(n²), Space: O(n) per result | Easy |
...
| 74 | [📓 Search a 2D Matrix](0074.ipynb) | Binary Search on Flattened Index | Time: O(log(m * n)), Space: O(1) | Medium |
| 81 | [📓 Search in Rotated Sorted Array II](0081.ipynb) | Binary Search with Duplicate Handling | Time: O(n) worst, O(log n) avg, Space: O(1) | Medium |
...
| 1300 | [📓 Sum of Mutated Array Closest to Target](1300.ipynb) | Binary Search, Array | O(n log n) Time, O(1) Space| Medium|
...
| 1062 | [📓 Longest Repeating Substring](1062.ipynb) | Binary Search, String| Time: O(n log n), Space: O(n)| Hard|
...
|701 | [📓 Insert into a Binary Search Tree](0701.ipynb) | Binary Search Tree | Time: O(h), Space: O(1)| Easy|
|729 | [📓 My Calendar I](0729.ipynb) | Binary Search Tree | Time: O(log n), Space: O(n)| Medium|
|731 | [📓 My Calendar II](0731.ipynb) | Binary Search Tree | Time: O(log n), Space: O(n)| Medium|
|538 | [📓 Convert BST to Greater Tree](0538.ipynb) | Binary Search Tree (BST) | Time: O(n), Space: O(h)| Easy|
|510 | [📓 Inorder Successor in BST II](0510.ipynb) | Binary Search Tree (BST) | Time: O(h), Space: O(1)| Medium|
|519 | [📓 Random Flip Matrix](0519.ipynb) | Binary Search Tree (BST) | Time: O(log n), Space: O(n)| Medium|
|528 | [📓 Random Pick with Weight](0528.ipynb) | Binary Search Tree (BST) | Time: O(log n), Space: O(n)| Medium|
|530 | [📓 Minimum Absolute Difference in BST](0530.ipynb) | Binary Search Tree (BST) | Time: O(n), Space: O(h)| Medium|

## Binary Tree
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
|543 | [📓 Diameter of Binary Tree](0543.ipynb) | Binary Tree| Time: O(n), Space: O(h)| Easy|
|617 | [📓 Merge Two Binary Trees](0617.ipynb) | Binary Tree| Time: O(n), Space: O(h)| Easy|
...
|5 | [📓 Longest Palindromic Substring](0005.ipynb) | Dynamic Programming| Time: O(n^2), Space: O(n^2)| Medium|
...
| 10 | [📓 Regular Expression Matching](0010.ipynb) | Dynamic Programming| Time: O(m * n), Space: O(m * n)| Hard|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
|1 | [📓 Two Sum](0001.ipynb) | Hash Map | Time: O(n), Space: O(n)| Easy|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
|7 | [📓 Reverse Integer](0007.ipynb) | Integer| Time: O(log x), Space: O(1)| Easy|
|9 | [📓 Palindrome Number](0009.ipynb) | Integer| Time: O(log x), Space: O(1)| Easy|
...
|2 | [📓 Add Two Numbers](0002.ipynb) | Linked List| Time: O(max(m, n)), Space: O(max(m, n))| Medium|
| 19 | [📓 Remove Nth Node From End of List](0019.ipynb) | One-Pass Two Pointers | Time: O(n), Space: O(1)| Medium|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
| 13 | [📓 Roman to Integer](0013.ipynb) | Math | Time: O(n), Space: O(1)| Easy|
...
| 12 | [📓 Integer to Roman](0012.ipynb) | Math | Time: O(1), Space: O(1)| Medium|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
| 493 | [📓 Reverse Pairs](0493.ipynb) | Binary Indexed Tree | Time: $O(n \log n)$, Space: $O(n)$ | Hard |
...
|3 | [📓 Longest Substring Without Repeating Characters](0003.ipynb) | Sliding Window, Hash Map | Time: O(n), Space: O(min(n, m))| Medium|
...
| 15 | [📓 3Sum](0015.ipynb) | Sorting, Two Pointers| Time: O(n^2), Space: O(1)| Medium|
| 16 | [📓 3Sum Closest](0016.ipynb) | Sorting, Two Pointers| Time: O(n^2), Space: O(1)| Medium|
| 18 | [📓 4Sum](0018.ipynb) | Sorting, Two Pointers| Time: O(n^3), Space: O(1)| Medium|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
| 20 | [📓 Valid Parentheses](0020.ipynb) | Stack| Time: O(n), Space: O(n)| Easy|
...
| Serial No. | Problem Title | Data Structure | Time and Space Complexity | Level |
| :--- | :--- | :--- | :--- | :--- |
|8 | [📓 String to Integer (atoi)](0008.ipynb) | String | Time: O(n), Space: O(1)| Easy|
| 14 | [📓 Longest Common Prefix](0014.ipynb) | String | Time: O(n * m), Space: O(1)| Easy|
...
|6 | [📓 Zigzag Conversion](0006.ipynb) | String, Array| Time: O(n), Space: O(n)| Medium|
...
| 11 | [📓 Container With Most Water](0011.ipynb) | Two Pointers | Time: O(n), Space: O(1)| Medium|
